...
import SuggestedUser from "../../src/components/SuggestedUsers/SuggestedUser"
...
const Search = () => {
  ...
  const handleClose = () => {
    onClose();
    if (setUser) setUser(null); // Limpia la búsqueda al cerrar
  };
      ...
      <Modal isOpen={isOpen} onClose={handleClose} motionPreset="slideInLeft">
        ...
        <ModalContent bg={"black"} border={"1px solid gray"} maxW={"400px"}>
          ...
          <ModalBody pb={6}>
            ...
            {/* Renderiza el resultado si se encuentra el usuario */}
